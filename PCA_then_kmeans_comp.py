...
Y = np.array(pca_results.loc[n_opt, "Pixels"]).reshape(48400,3)
...
plt.imshow(np.array(kmeans_result.loc[k_opt, "Pixels"]/255).reshape(*ori_img.size, 3))